...
class CustomerControllerTest {
    ...
    public void createCustomers(){
        ...
        customers.add(new CustomerEntity(1,"Helm de México", "prueba@gmail.com", null));
        customers.add(new CustomerEntity(2,"Ingredion México", "prueba2@gmail.com", null));
        customers.add(new CustomerEntity(3,"Gapelli", "prueba3@gmail.com", null));
        customers.add(new CustomerEntity(4,"AGR Representaciones", "prueba4@gmail.com", null));
    ...
    void get_customers_by_id(){
        customer = new CustomerEntity(6, "General Products", "general@gmail.com", null);
    ...
    public void save_new_customer() {
        customer = new CustomerEntity(5, "DVA", "dva@gmail.com", null);
